     ...
     <body>
		<header>
	 	...
	 	<section class="history">
			<h1>QUEM SOMOS ?</h1>
			<p class="text-break">Apenas dois desenvolvedores Junior buscando aprimorar seus conhecimentos, este site Ã© um trabalho prÃ¡tico, uma prova de nossa dedicaÃ§Ã£o e capacidade. Acreditamos que com esforÃ§o, dedicaÃ§Ã£o e corajem tudo se torna possÃ­vel, e esperamos que nossos dias de luta se tornem dias de gloria em breve, inspirando futuros devs. Com carinho Juan Linhares Teles Batista & Renan Vinicius dos Santos Ribeiro.</p>	
	 	</section>
		 <div class="decoration"></div>
	 	<section class="bio">
	 		<div class="box">
	 			...
	 			<div class="content">
	 				...
	 				<p class="text-break">Nasceu em Caraguatatuba, cidade linda, gosta de programar nas horas que nÃ£o esta procrastinando, atualmente estÃ¡ estudando GestÃ£o da Tecnologia da InformaÃ§Ã£o na Faculdade TÃ©cnica do Estado de SÃ£o Paulo em SÃ£o sebastiÃ£o, outra cildade maravilhosa, gosta de trabalhar em equipe porÃ©m odeia pessoas</p>
	 			</div>
	 		</div>
	 		<div class="boxtwo">
	 			<div class="imgbxtwo">
	 			...
	 			<div class="contentwo">
	 				...
	 				<p class="text-break">Nasceu em SÃ£o Paulo, cof cof, gostaria de gostar de programar, atualmente estÃ¡ estudando GestÃ£o da Tecnologia da InformaÃ§Ã£o na Faculdade TÃ©cnica do Estado de SÃ£o Paulo em SÃ£o sebastiÃ£o, amo pessoas mas odeio trabalhar em equipe. </p>
	 			</div>
	 		</div>
	 	</section>
		 <footer class="footer">
