...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond&family=Inika&family=Karantina&display=swap" rel="stylesheet">
	 ...
	 <body>
	 	...
	 	<section class="titulonoticia">
	 		<h1>${noticia.getTitulo() }</h1>
	 		<h2>${noticia.getMiniTitulo() }</h2>
	 		<h3>Por ${noticia.getAutores()} em 12 de junho, 2022 �s 11:55</h3>
	 			<div class="imgnoticia">
	 		        <img src="imagens/${noticia.getCodigo()}/${noticia.getNomeFoto()}">
	 	        </div>
	 	</section>
