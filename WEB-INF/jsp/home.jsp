    ...
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond&family=Inika&family=Karantina&display=swap" rel="stylesheet">
	 ...
	 <body>
		...
		<section class="noticias">
			<h1>NOTICIAS</h1>
			<p>All | Nintendo Playstation Xbox Steam</p>
		...
		<section class="games">
			...
			<c:forEach var="couter" begin="0" end="${tamanho - 1}">
				<a href=""><img src="imagens/${ listaPasta[couter]}/${listaNomeMiniatura[couter]}" alt="" width="194" height="259"></a>
			</c:forEach>
			<a href=""><img src="imagens/novapasta3/GameCritic4.png"></a>
			</div>
		</section>
