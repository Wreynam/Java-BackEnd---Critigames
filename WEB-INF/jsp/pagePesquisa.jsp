    ...
    <header>
			<div class="header-top">
				<div class="search-box">
						<input class="search-txt" name="pesquisa" placeholder="Pesquisar">
						<a class="search-btn" href="buscarCategorias">
							<img src="./img/icons-earch.png" alt="" sizes="120x120">
						</a>
					</div>
				<div class="container-tittleNo">
					<p class="tittle">CRITIGAMES${pesquisa}</p>
     ...
     <div class="containerDeItens">
        <c:forEach var="couter" begin="0" end="${tamanho -1}">
			<a href=""><img src="imagens/${ listaBusca[couter].getNomePasta()}/${listaBusca[couter].getNomeFotoMiniatura()}" alt="" width="194" height="259"></a>
		</c:forEach>
     </div>
